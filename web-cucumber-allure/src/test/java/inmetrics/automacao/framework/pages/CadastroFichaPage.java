...
public class CadastroFichaPage extends InteracoesTelaWeb {
    ...
    @FindBy(how = How.XPATH, xpath = "(//label[contains(text(), 'Estado civil')]/following-sibling::ngx-select/div)[2]")
    public WebElement campoEstadoCivilAvalista;
    ...
    @FindBy(how = How.XPATH, xpath = "//input[@value='USADO']")
    protected WebElement checkEstadoVeiculoUsado;

    @FindBy(how = How.XPATH, xpath = "(//label[contains(text(), 'Marca')]/following-sibling::ngx-select/div)[1]")
    ...
    @FindBy(how = How.XPATH, xpath = "//span[contains(text(), '15979 - PC Taxa - 0% a.m FEV/2022')]")
    ...
    @FindBy(how = How.XPATH, xpath = "(//label[contains(text(), 'Simular seguro do veículo?')]/following-sibling::label/input)[2]")
    ...
    @FindBy(how = How.XPATH, xpath = "//span[contains(text(), 'Seguro do Veículo')]")
    protected WebElement tituloSeguroDoVeiculo;
    ...
    public void preencherIdentificacaoConjuge(String regimeCasamento, String nome, String cpf, String data) throws InterruptedException {
    ...
    public void clicarSalvarCliente() throws InterruptedException {
    ...
    public void preencherCamposVeiculo(String anoFabricacao, String anoModelo, String tipoVeiculo, String estadoVeiculo,
                                          String marca, String modelo, String valor, String quantidade, String adicionarAcessorio,
        ...
        clicarElemento(opcaoComboTipoVeiculoCarroPasseio, 60);
